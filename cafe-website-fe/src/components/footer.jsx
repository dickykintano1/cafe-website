...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#4a372d] text-[#cccccc] pt-15 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border-t border-[#d4b996] py-6 flex justify-between items-start text-2xl">
          <ul className="space-y-2">
            ...
            <li><a href="/merchandise" className="hover:opacity-70 transition-opacity">Merchandise</a></li>
          </ul>
          <div className="text-right flex flex-col gap-2">
            <a href="/reserve" className="md:text-2xl hover:opacity-70 transition-opacity">
              Reserve
            </a>
